<!-- Top Navbar -->
<nav id="top_bar" class="navbar bg-light border-bottom fixed-top pt-5 shadow">
...
<!-- Mobile Tabbar -->
<nav id="tab_bar" class="navbar border-top fixed-bottom bg-light shadow">
    <ul class="navbar-nav nav-justified w-100 list-group list-group-horizontal">
        <li class="nav-item">
...
<div class="container-fluid d-flex h-100">
    <div class="row">
        <div id="side_bar" style="width: 280px; padding: 0;" class="col h-100 position-fixed">
            <!-- SideBar -->
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary h-100 shadow" style="width: 280px">
                ...
                <ul class="nav nav-pills flex-column mb-auto breadcrumb">
                    <li class="nav-item mb-2 breadcrumb-item">
                        <a href="../views/index.php" class="nav-link active p-2" aria-current="page">
                    ...
                    <li class="mb-2">
                        <a href="../views/setting.php" class="nav-link link-body-emphasis p-2">
