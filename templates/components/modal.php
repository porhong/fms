                ...
                <div class="modal-header">
                    ...
                    <div class="d-flex align-items-md-end ">
                        ...
                        <div id="btn_new_type" class="text-center d-flex justify-align-content-center align-items-center border border-none border-2 border-primary rounded-3 me-3 btn">
                            ...
                            <p class="text-color-primary fw-bold m-0 me-lg-1 ">New</p>
                        </div>

                        <div id="btn_edit_type" class="text-center d-flex justify-align-content-center align-items-center border border-none border-2 border-primary rounded-3 me-3 btn" data-bs-dismiss="modal">
                            <i class="uil uil-pen fs-4 d-flex align-items-center text-color-primary pe-1 d-none d-lg-inline"></i>
                            <p class="text-color-primary fw-bold m-0 me-lg-1 ">Edit</p>
                        </div>
