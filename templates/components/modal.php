                    ...
                    <form class="col" method="POST" action="">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-check form-switch form-switch-lg">
                                <input onclick="stt()" class="form-check-input" type="checkbox" role="switch" id="sw_status" name="sw_status" state='failed' default=off>
                            </div>
    ...
    <div class="modal fade" id="<?php echo $modal_id_get ?>">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div id="modal_body" class="modal-body">
                    ...
                    <form class="col" method="POST" action="">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="form-check form-switch form-switch-lg">
                                <input onclick="stt()" class="form-check-input" type="checkbox" role="switch" id="sw_status_update" name="sw_status_update" state='failed' default=off>
                            </div>
                            <div class="switch_state">
                                <span class="fw-medium fs-6 me-2 text-color-error">Disactive</span>
                            </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <a class="btn_delete"><button id="btn_submit_update" value="create_user" name="create_user" type="submit" class="btn btn-primary" disabled><?php echo $modal_button_title_get ?></button></a>
