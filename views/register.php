            ...
            <form class="col-md-6 rigtt-box" method="POST" action="">
                ...
                <div class="row mb-2">
                    <div class="col form-floating input" id="block_txt_first_name">
                        <input oninput="verifyInput('txt_first_name','First name is required')" type="text" class="form-control form-label form-control-lg bg-light fs-6" placeholder="First Name" name="txt_first_name" id="txt_first_name" required>
